// functions to manage consistent user data(like ratings and department) across pages
...
// retrieve user extras from localStorage or generate new ones
...
// initialize user extras for multiple users at once
